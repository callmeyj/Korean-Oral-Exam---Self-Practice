...
const KB_QUESTIONS = {
  ...
  "Friends, recreation & pastimes": [
    "취미가 뭐예요?","그 취미를 언제 시작했어요?","어떤 영화를 좋아해요?",
    "운동을 좋아해요?","제일 친한 친구는 누구예요?","(그 친구는) 어떤 사람이에요?",
    "자유 시간에 친구들을 만나면 보통 뭐 해요?","무슨 음악을 좋아해요?",
    "자기 전에 보통 뭐 해요?","매일 아침밥을 먹어요?","무슨 요일을 제일 좋아해요?",
  ],
  "People, places & communities": [
    "무슨 계절을 가장 좋아해요?","어떤 날씨가 좋아요?",
    "당신의 동네 이름은 뭐예요?","동네에서 뭐를 할 수 있어요?",
    "무슨 음식을 좋아해요?","쇼핑을 좋아해요?",
    "한국 식당에 자주 가요?","주말에 날씨가 좋으면 뭐 하고 싶어요?",
    "당신의 집 근처에 뭐가 있어요?","나중에 어디에서 살고 싶어요?",
  ],
  "Education & work": [
    "무슨 과목을 제일 좋아해요?","제일 어려운 과목은 뭐예요?",
    "왜 한국어를 공부해요?","학교 수업이 끝나면 뭐 해요?",
    "보통 매일 몇 시간 공부해요?","엄격한 선생님이 좋아요?",
    "당신은 아르바이트를 해요?","어떤 아르바이트를 하고 싶어요?",
    "집에서 학교까지 얼마나 걸려요?","외국어를 배우는 것이 왜 필요하다고 생각해요?",
  ],
  "Holidays, travel & tourism": [
    "이번 주말에 뭐 할 계획이에요?","지난 방학에 뭐 했어요?",
    "여행을 좋아해요?","어디로 여행을 가고 싶어요?",
    "한국에 가면 뭐 하고 싶어요?","한국에 가면 어디에 가고 싶어요?",
    "한국 음식을 먹을 수 있어요?","방학 때 뭐가 제일 좋았어요?",
  ],
  "Future plans & aspirations": [
    "무슨 직업을 갖고 싶어요?","장래 희망이 뭐예요?",
...
const KC_QUESTIONS = {
  ...
  "Korea as a tourist destination": [
    ...
    "한국 음식 중에서 가장 먹어보고 싶은 것은 뭐예요?",
    "한국의 전통문화와 현대문화 중 어느 쪽이 더 흥미로워요?",
  ],
  "Daily life in Korea": [
